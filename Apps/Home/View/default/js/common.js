...
/*function addToFavorite(){
	var a=domainURL ,b="收藏{$CONF['shopTitle']['fieldValue']}";
...
function addToFavorite() {
	...
	if (document.all) {
		window.external.AddFavorite(d, c); // IE
	} else {
		if (window.sidebar) {
			window.sidebar.addPanel(c, d, ""); // FF
		} else {
